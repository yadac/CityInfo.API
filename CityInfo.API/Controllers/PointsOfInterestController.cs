...
namespace CityInfo.API.Controllers
{
    ...
    public class PointsOfInterestController : Controller
    {
        ...
        public IActionResult CreatePointOfInterest(int cityId, [FromBody] PointOfInterestForCreationDto pointOfInterest)
        {
            ...
            var createPointOfInterestForReturn = Mapper.Map<PointOfInterestDto>(finalPointOfInterest);

            // like get behavior?
            return CreatedAtRoute("GetPointOfInterest", 
                new { cityId = cityId, pId = createPointOfInterestForReturn.Id }, createPointOfInterestForReturn);
        }
        ...
        public IActionResult UpdatePointOfInterest(int cityId, int pId, [FromBody] PointOfInterestForUpdateDto pointOfInterest)
        {
            ...
            var pointOfInterestEntity = _cityInfoRepository.GetPointOfInterestForCity(cityId, pId);
